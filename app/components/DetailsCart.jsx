...
export default function DetailsCart({ cart, isVisible, toggleVisible, removeToCart }) {
  return (
      ...
      <div className="fixed inset-0 z-10 overflow-y-auto">
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
            <div className="bg-white dark:bg-neutral-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              <div className="sm:flex sm:items-start">
                <div className="mt-3 text-left sm:mt-0 sm:ml-4">
                  <h3 className="text-2xl font-semibold leading-6 text-neutral-900 mb-8 dark:text-white">Carro de compras</h3>
                  <table className="border-collapse">
                    {cart.length === 0 ? null :
                      <thead className="grid grid-cols-4 w-full sm:w-96 mb-8 text-neutral-900 dark:text-white">
                        <tr>
                    ...
                    <tbody className="max-h-52 text-neutral-900 dark:text-white">
                      {cart.map((item, idx) => {
                        return (
            ...
            <div className="bg-neutral-50 dark:bg-neutral-600 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              <button
