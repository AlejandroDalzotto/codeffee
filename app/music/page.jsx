            ...
            <section className="grid justify-items-center px-2 py-20">
                <article className="container mx-auto max-w-[978px]">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                        ...
                        <div>
                            <iframe style={{ borderRadius: 12 }} src="https://open.spotify.com/embed/playlist/5pKbVvYPM6fPPEAfY0LOvi?utm_source=generator" width="100%" height="352" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
                        </div>
                        <div>
                            <iframe style={{ borderRadius: 12 }} src="https://open.spotify.com/embed/playlist/6i77tdTRuCegrvmcVGTo2i?utm_source=generator" width="100%" height="352" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
                        </div>
                        <div>
                            <iframe style={{ borderRadius: 12 }} src="https://open.spotify.com/embed/playlist/19n65kQ5NEKgkvSAla5IF6?utm_source=generator&theme=0" width="100%" height="352" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
                        </div>
                    </div>
                </article>
            </section>
