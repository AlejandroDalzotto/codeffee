      ...
      <div className="relative home-bg bg-cover bg-no-repeat bg-center h-[calc(100vh-88px)]">
        <div className="container mx-auto flex items-center justify-around h-[calc(100%-88px)] p-4">
          <div className="md:max-w-[50ch]">
            <h1 className="text-5xl text-center md:text-left text-neutral-50 font-bold">Codeffee</h1>
            <p className="my-8 text-neutral-300 font-medium text-base lg:text-lg">En nuestra cafetería, te ofrecemos un espacio acogedor donde puedes relajarte y disfrutar de un delicioso café que te transportará a otro mundo.</p>
          </div>
